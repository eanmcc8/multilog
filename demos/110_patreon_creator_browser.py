...
"""Demo: Patreon creator browser — browse creator pages and feed."""
import asyncio
import os
import random
...
async def main():
    ...
    url = os.getenv("PATREON_URL", "https://www.patreon.com/explore")
    scrolls = int(os.getenv("PATREON_SCROLLS", "5"))
    banner("Patreon Creator Browser", f"Explore feed  |  {timestamp()}")
    mlx = MultiloginX()
