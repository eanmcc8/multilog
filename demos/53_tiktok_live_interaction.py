...
"""Demo: TikTok live interaction — hearts and comments from MLX profile."""
import asyncio
import os
import random
...
async def main():
    ...
    banner("TikTok Live Interaction", f"Hearts + comments  |  {timestamp()}")
    if not live_url:
