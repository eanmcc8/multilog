...
"""Demo: Stripe checkout tester — QA payment flow on your own checkout."""
import asyncio
import os
...
async def main():
    ...
    banner("Stripe Checkout Tester", f"Payment flow QA  |  {timestamp()}")
    warn("Use Stripe test mode or your own merchant — card fraud is illegal")
    if not checkout_url:
